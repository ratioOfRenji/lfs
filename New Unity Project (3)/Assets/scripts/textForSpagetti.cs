...
public class textForSpagetti : MonoBehaviour
{
    ...
    void Update()
    {
        firstItemText.text = (GMScript1.potatoSeeds + " / 2    " + GMScript1.sunFlowerSeeds + " / 2 ").ToString();
        secondImageText.text = (GMScript1.sunFlowerSeeds + " / 2    " + GMScript1.yaytsa + " / 2    " + GMScript1.cowMilk + " / 2").ToString();
        thirdImageText.text = (GMScript1.sunFlowerSeeds + " / 2    " + GMScript1.carrotSeeds + " / 2    " + GMScript1.potatoSeeds + " / 2" + GMScript1.yaytsa + " / 2" + GMScript1.cowMilk + " / 2").ToString();

        if ((GMScript1.potatoSeeds < 2) || (GMScript1.sunFlowerSeeds < 2))
        {
        ...
        if ((GMScript1.sunFlowerSeeds < 2) || (GMScript1.yaytsa < 2) || (GMScript1.cowMilk < 2))
        {
        ...
        if ((GMScript1.sunFlowerSeeds < 2) || (GMScript1.carrotSeeds < 2) || (GMScript1.potatoSeeds < 2) || (GMScript1.yaytsa < 2) || (GMScript1.cowMilk < 2))
        {
