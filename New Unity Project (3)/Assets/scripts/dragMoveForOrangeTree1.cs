...
public class dragMoveForOrangeTree1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (clickStageCheckerOrangeTree1.ClickState == clickStageCheckerOrangeTree1.clickState.noClick)
        {
        ...
        if (clickStageCheckerOrangeTree1.ClickState == clickStageCheckerOrangeTree1.clickState.click)
        {



        }
        if (clickStageCheckerOrangeTree1.ClickState == clickStageCheckerOrangeTree1.clickState.doubleClick)
        {
            
            cameraDisable.SetActive(false);
            GMScript1.pecarniaUiIsActive = true;
        }
        if (clickStageCheckerOrangeTree1.ClickState == clickStageCheckerOrangeTree1.clickState.longClick)
        {
        ...
        if ((colision) && (clickStageCheckerOrangeTree1.ClickState == clickStageCheckerOrangeTree1.clickState.longClick))
        {
