...
public class textForJuiceMachine : MonoBehaviour
{
    ...
    void Update()
    {
        firstItemText.text = (GMScript1.apple + " / 4    " + GMScript1.sugar + " / 2    ").ToString();
        secondImageText.text = (GMScript1.grape + " / 4    " + GMScript1.sugar + " / 2    ").ToString();
        thirdImageText.text = (GMScript1.cherry + " / 4    " + GMScript1.sugar + " / 2    ").ToString();

        if ((GMScript1.apple < 4) || (GMScript1.sugar < 2))
        {
        ...
        if ((GMScript1.grape < 4) || (GMScript1.sugar < 2) )
        {
        ...
        if ((GMScript1.cherry < 4) || (GMScript1.sugar < 2))
        {
