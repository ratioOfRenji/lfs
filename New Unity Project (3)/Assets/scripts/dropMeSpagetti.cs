...
public class dropMeSpagetti : MonoBehaviour, IDropHandler
{
    cookSpagettiMachine Cook;
    ...
    void Start()
    {
        Cook = GameObject.FindGameObjectWithTag("spagetti").GetComponent<cookSpagettiMachine>();
    }
