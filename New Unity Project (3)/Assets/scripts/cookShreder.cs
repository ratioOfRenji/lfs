...
public class cookShreder : MonoBehaviour
{
    ...
    public void CookSugar()
    {
        Debug.Log("тростника: " + GMScript1.sugarPlantSeeds);
        if (GMScript1.sugarPlantSeeds >= requiredNumberSugarPlant)
        {
            if ((slotArray[1] == 0) && (imageSlotArray[1] == 0))
            {
                if ((slotArray[0] == 0) && (imageSlotArray[0] == 0))
                {
                    ...
                    GMScript1.sugarPlantSeeds -= requiredNumberSugarPlant;
                    Debug.Log("тростника: " + GMScript1.sugarPlantSeeds);
                    startOneTimer = true;
                    slotArray[0] = 1;
    ...
    public void CookCoffee()
    {
        ...
        if (GMScript1.coffeeSeeds >= requiredNumberCoffeBeans)
        {
            if ((slotArray[1] == 0) && (imageSlotArray[1] == 0))
            {
                if ((slotArray[0] == 0) && (imageSlotArray[1] == 0))
                {
                    ...
                    GMScript1.coffeeSeeds -= requiredNumberCoffeBeans;
                    Debug.Log("семян кофе: " + GMScript1.coffeeSeeds);
                    startOneTimer = true;
                    slotArray[0] = 2;
