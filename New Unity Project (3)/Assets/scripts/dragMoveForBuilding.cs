...
public class dragMoveForBuilding : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (clickStageChecker.ClickState == clickStageChecker.clickState.noClick)
            {
            ...
            if (clickStageChecker.ClickState == clickStageChecker.clickState.click)
            {



            }
            if (clickStageChecker.ClickState == clickStageChecker.clickState.doubleClick)
            {
                bakeryUi.SetActive(true);
                cameraDisable.SetActive(false);
                GMScript1.pecarniaUiIsActive = true;
            }
            if (clickStageChecker.ClickState == clickStageChecker.clickState.longClick)
            {
            ...
            if ((colision) && (clickStageChecker.ClickState == clickStageChecker.clickState.longClick))
            {
