...
public class textForGrill : MonoBehaviour
{
    ...
    void Update()
    {
        firstItemText.text = (GMScript1.wheatBread + " / 2    " + GMScript1.goatCheese + " / 2 ").ToString();
        secondImageText.text = (GMScript1.whiteBreat + " / 2    " + GMScript1.goatCheese + " / 2    " + GMScript1.tomatoes + " / 2").ToString();
        thirdImageText.text = (GMScript1.sunFlowerSeeds + " / 2    " + GMScript1.orange + " / 2    " + GMScript1.sugar + " / 2" + GMScript1.cowMilk + " / 2" + GMScript1.yaytsa + " / 2").ToString();

        if ((GMScript1.wheatBread < 2) || (GMScript1.goatCheese < 2))
        {
        ...
        if ((GMScript1.whiteBreat < 2) || (GMScript1.goatCheese < 2) || (GMScript1.tomatoes < 2))
        {
        ...
        if ((GMScript1.sunFlowerSeeds < 2) || (GMScript1.orange < 2) || (GMScript1.sugar < 2) || (GMScript1.cowMilk < 2) || (GMScript1.yaytsa < 2))
        {
