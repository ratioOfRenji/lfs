...
public class cookBakery : MonoBehaviour
{
    ...
    public void CookWheatBread()
    {
        ...
        if ((GMScript1.cowMilk >= requiredNumberSugarPlant) && (GMScript1.sunFlowerSeeds >= requiredNumberSugarPlant))
        {
            if ((slotArray[1] == 0) && (imageSlotArray[1] == 0))
            {
                if ((slotArray[0] == 0) && (imageSlotArray[0] == 0))
                {
                  //  Debug.Log("готовим сахар!");
                    GMScript1.cowMilk --;
                    GMScript1.sunFlowerSeeds -= requiredNumberSugarPlant;
                    // Debug.Log("тростника: " + GMScript1.sugarPlantSeeds);
                    startOneTimer = true;
                    slotArray[0] = 1;
